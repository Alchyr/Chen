...
public class PentagramFlight extends StandardSpell {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(mo, p, new Disoriented(mo, magicNumber), magicUpgrade));
        }
